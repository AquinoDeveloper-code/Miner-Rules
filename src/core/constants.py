# ============================================================
# src/core/constants.py — Constantes globais do jogo
# ============================================================

# ============================================================
# CONFIGURAÇÕES PRINCIPAIS — altere aqui para balancear
# ============================================================
...
GROWTH_TIME        = 180.0  # Segundos de jogo para bebê virar adulto
...
SHOP_REFRESH_TIME  = 300.0  # Segundos reais entre refreshes da loja
...
# ------ Layout dos painéis ------
# Painel esquerdo: LOG DE EVENTOS (scrollável, com timestamps)
# Painel central : Lista de escravos
# Painel direito : Mine visual (topo) + Recursos/Stats (baixo)

TOP_H     = 40                            # Barra superior
BOTTOM_H  = 160                           # Painel de abas
MAIN_H    = SCREEN_HEIGHT - TOP_H - BOTTOM_H   # 520 px de área principal

LEFT_W    = 320    # Log de eventos
CENTER_W  = 490    # Lista de escravos
RIGHT_W   = SCREEN_WIDTH - LEFT_W - CENTER_W   # 470 px (mina + recursos)

MINE_VISUAL_H = 200   # Porção superior do painel direito: visual da mina
...
RESOURCE_ORDER = list(RESOURCES.keys())
...
MINE_UPGRADES = {
    ...
    "alimentacao": {
        "nome": "Alimentação",
        "desc": "Reduz desgaste e aumenta lealdade",
        "niveis": [
    ...
    "seguranca": {
        "nome": "Segurança",
        "desc": "Reduz mortes por acidente e rebelião",
        "niveis": [
    ...
    "iluminacao": {
        "nome": "Iluminação",
        "desc": "Aumenta sorte de encontrar recursos raros",
        "niveis": [
    ...
    "ventilacao": {
        "nome": "Ventilação",
        "desc": "Reduz o intervalo de mineração",
        "niveis": [
...
ACHIEVEMENTS = [
    ...
    {"id": "legiao",     "nome": "Legião Eterna",          "desc": "Tenha 50 escravos ao mesmo tempo",     "cond": ("escravos_vivos", 50)},
    ...
    {"id": "nascimento", "nome": "Berço da Mina",          "desc": "Primeiro filho nascido",               "cond": ("filhos", 1)},
...
# PRESTÍGIO
# ============================================================
PRESTIGE_GOLD_REQ   = 100_000
PRESTIGE_BONUS_STEP = 0.10
